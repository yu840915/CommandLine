...
internal class CommandLineTests: XCTestCase {
  ...
  func testBoolOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "--bool", "-c", "-c", "-ddd" ])
  ...
  func testIntOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "1", "--bigs", "2", "-c", "3",
      "-c", "4", "-ddd", "-e", "bad", "-f", "-g", "-5" ])
    ...
    } catch let CommandLineKit.CommandLineArgumentParser.ParseError.invalidValueForOption(opt, vals) {
  ...
  func testCounterOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "--bach", "-c", "-c",
  ...
  func testDoubleOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "1.4", "--baritone", "2.5",
  ...
  func testDoubleOptionsInAlternateLocale() {
    let cli = CommandLineArgumentParser(arguments: ["CommandLineTests", "-a", "3,14159"])
    let a = DoubleOption(shortFlag: "a", longFlag: "a1", required: true, helpMessage: "")
  ...
  func testStringOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "one", "--b1", "two", "-c", "x", "-c", "xx",
      "--d1", "y", "--d1", "yy", "-e" ])
  ...
  func testMultiStringOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "one", "-b", "two", "2wo",
  ...
  func testConcatOptionWithValue() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-xvf", "file1", "file2" ])
  ...
  func testMissingRequiredOption() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "-b", "foo", "-q", "quux" ])
    let c = StringOption(shortFlag: "c", longFlag: "c1", required: true, helpMessage: "")
    ...
    } catch let CommandLineKit.CommandLineArgumentParser.ParseError.missingRequiredOptions(opts) {
  ...
  func testAttachedArgumentValues() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a=5", "--bb=klaxon" ])
  ...
  func testEmojiOptions() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-👻", "3", "--👍", "☀️" ])
  ...
  func testEnumOption() {
    ...
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "--operation", "x" ])
  ...
  func testArgumentStopper() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "--", "-value", "--", "-55" ])
  ...
  func testFlagStyles() {
    ...
    for args in argLines {
      let cli = CommandLineArgumentParser(arguments: args)
  ...
  func testEmptyFlags() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-", "--"])
  ...
  func testShortFlagReuse() {
    let cli = CommandLineArgumentParser(arguments: [])
  ...
  */
  ...
  func testMixedExample() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-dvvv", "--name", "John Q. Public",
  ...
  func testWasSetProperty() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "-a", "-b", "-c", "str", "-d", "1",
  ...
  func testShortFlagOnlyOption() {
    let cli = CommandLineArgumentParser(arguments: ["-s", "itchy", "--itchy", "scratchy"])
  ...
  func testStrictMode() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "--valid", "--invalid"])
    ...
    } catch let CommandLineKit.CommandLineArgumentParser.ParseError.invalidArgument(arg) {
  ...
  func testUnparsedArguments() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "onefish", "twofish", "-b", "redfish", "-c", "green", "blue", "-xvvi", "9", "-w", "--who", "--formats=json", "xml", "binary", "--verbose", "fish", "--type=pdf", "woo!"])
    ...
    do {
      let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "onefish", "twofish", "-b", "redfish", "-c", "green", "blue", "-xvvi", "9", "--formats=json", "xml", "binary", "--verbose", "fish", "--type=pdf", "woo!"])
      o4.reset()
      cli.addOptions(o1, o2, o3, o4, o5, o6, o7)
  ...
  func testInvalidArgumentErrorDescription() {
    let cli = CommandLineArgumentParser(arguments: [ "CommandLineTests", "--int", "invalid"])
  ...
  func testPrintUsageToStderr() {
    ...
    let error = CommandLineArgumentParser.ParseError.invalidArgument("ack")
